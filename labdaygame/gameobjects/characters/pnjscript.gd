...
func setname(index : int):
	...
	match index:
		0:namepath = "res://Ninja Adventure - Asset Pack/Actor/Characters/Princess/Faceset.png"
		1:namepath = "res://Ninja Adventure - Asset Pack/Actor/Characters/NinjaMageBlack/Faceset.png"
